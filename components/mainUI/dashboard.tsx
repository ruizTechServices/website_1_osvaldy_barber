/**
 * v0 by Vercel.
 * @see https://v0.dev/t/Xc46zsnTRr9
...
export default function Dashboard() {
  return (
    <div className="grid min-h-screen w-full overflow-hidden lg:grid-cols-[280px_1fr]">
      <div className="hidden border-r bg-black lg:block text-white">
        <div className="flex flex-col gap-2">
          <div className="flex h-[60px] items-center px-6">
            <Link href="#" className="flex items-center gap-2 font-semibold" prefetch={false}>
              <Package2Icon className="h-6 w-6" />
              <span className="bg-black"><Image width={200} height={200} src={'/images/logo-transparent.png'} alt={""} /></span>
            </Link>
          </div>
          <div className="flex-1">
            <nav className="grid items-start px-4 text-sm font-medium">
              <Link
                href="#"
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 hover:bg-gray-300 dark:text-gray-400 dark:hover:text-gray-50"
                prefetch={false}
              >
      ...
      <div className="flex flex-col">
        <header className="flex h-14 lg:h-[60px] items-center gap-4 border-b bg-black text-white px-6">
          <div className="flex-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="rounded-full">
                  <img src="/placeholder.svg" width="32" height="32" className="bg-white rounded-full" alt="Avatar" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Total sales and revenue for the current month.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span>Revenue</span>
                    <span className="font-semibold">$32,456</span>
                  </div>
                </div>
              </CardContent>
            </Card>
