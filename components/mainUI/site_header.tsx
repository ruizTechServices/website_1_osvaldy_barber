...
export default function SiteHeader() {
  ...
  return (
    <div className="p-20 bg-black h-[1000px] w-full lg:h-[800px] relative overflow-hidden md:mx-25">
      <img
      ...
      <img
        ...
        className="transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none w-[20em] absolute top-[750px] md:top-[7px] md:left-[780px] lg:w-[500px] lg:h-[500px] left-10"
      />
    </div>
  );
}
